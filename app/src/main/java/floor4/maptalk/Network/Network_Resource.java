...
public class Network_Resource {
    public static final String url = "http://203.253.25.72:6789/";
    ...
    public static final int MSGResponseSendPing     = 9;
    public static final int MSGResponseJoin        = 10;
    public static final int MapPrintPing      = 101;
    public static final int ErrUnstableNetwork = 201;
